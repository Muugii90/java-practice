...
public class LogicalBooleanValues {
	...
	boolean isMore3Pm = true;
	boolean everyThingClear = true ||false; // true && !false  // 
	boolean letsGoForBreak = topicDone && isMore3Pm && everyThingClear;
	System.out.println("Let is go for break: "+ letsGoForBreak);
