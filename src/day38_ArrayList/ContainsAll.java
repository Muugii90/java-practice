...
public class ContainsAll {
	...
	public static void main(String[] args) {
		...
		if(nums2.containsAll(nums1)) {
			...
			System.out.println("Nums2 does not containAll nums1");
		}
		...
		if(planB.containsAll(planA)&& planA.containsAll(planB)) {
			...
			System.out.println("Plans A and B does not match");
		}
		
		boolean b = planA.equals(planB);
